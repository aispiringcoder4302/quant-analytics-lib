...
class TestModule:
    def test_get_api_ref(self):
        ...
        assert vbt.get_fqn(vbt) == "vectorbtpro"
        assert vbt.get_fqn(vbt.utils) == "vectorbtpro.utils"
        assert vbt.get_fqn(vbt.utils.datetime_) == "vectorbtpro.utils.datetime_"
        assert vbt.get_fqn(vbt.dt) == "vectorbtpro.utils.datetime_"
        assert vbt.get_fqn(vbt.nb) == "vectorbtpro.generic.nb"
        assert vbt.get_fqn(vbt.nb.rolling_mean_nb) == "vectorbtpro.generic.nb.rolling.rolling_mean_nb"
        assert vbt.get_fqn(vbt.settings) == "vectorbtpro._settings.settings"
        assert vbt.get_fqn(vbt.Portfolio) == "vectorbtpro.portfolio.base.Portfolio"
        assert vbt.get_fqn(vbt.PF) == "vectorbtpro.portfolio.base.Portfolio"
        assert vbt.get_fqn(vbt.Data.fetch_symbol) == "vectorbtpro.data.base.Data.fetch_symbol"
        assert vbt.get_fqn(vbt.YFData.fetch_symbol) == "vectorbtpro.data.custom.yf.YFData.fetch_symbol"
        assert vbt.get_fqn(vbt.Data.run) == "vectorbtpro.data.base.Data.run"
        assert vbt.get_fqn(vbt.YFData.run) == "vectorbtpro.data.base.Data.run"
        assert vbt.get_fqn(vbt.PF.cash_sharing) == "vectorbtpro.portfolio.base.Portfolio.cash_sharing"
        assert vbt.get_fqn(vbt.PF.close) == "vectorbtpro.portfolio.base.Portfolio.close"
        assert vbt.get_fqn(vbt.PF.plot_value) == "vectorbtpro.portfolio.base.Portfolio.plot_value"
        assert vbt.get_fqn(vbt.PF.get_filled_close) == "vectorbtpro.portfolio.base.Portfolio.get_filled_close"
        assert vbt.get_fqn(vbt.PF.get_sharpe_ratio) == "vectorbtpro.portfolio.base.Portfolio.get_sharpe_ratio"
        assert vbt.get_fqn(vbt.PF.sharpe_ratio) == "vectorbtpro.portfolio.base.Portfolio.sharpe_ratio"
        assert vbt.get_fqn(vbt.ADX) == "vectorbtpro.indicators.custom.adx.ADX"
        assert vbt.get_fqn(vbt.ADX.adx) == "vectorbtpro.indicators.custom.adx.ADX.adx"
        assert vbt.get_fqn(vbt.ADX.adx_above) == "vectorbtpro.indicators.custom.adx.ADX.adx_above"
        assert vbt.get_fqn(pf.plot_value) == "vectorbtpro.portfolio.base.Portfolio.plot_value"
        assert vbt.get_fqn(pf.get_filled_close) == "vectorbtpro.portfolio.base.Portfolio.get_filled_close"
        assert vbt.get_fqn(pf.get_sharpe_ratio) == "vectorbtpro.portfolio.base.Portfolio.get_sharpe_ratio"
        ...
        assert vbt.get_fqn((vbt, "Data", "run")) == "vectorbtpro.data.base.Data.run"
        assert vbt.get_fqn((vbt, "YFData", "run")) == "vectorbtpro.data.base.Data.run"
        assert vbt.get_fqn((pf, "cash_sharing")) == "vectorbtpro.portfolio.base.Portfolio.cash_sharing"
        assert vbt.get_fqn((pf, "close")) == "vectorbtpro.portfolio.base.Portfolio.close"
        assert vbt.get_fqn((pf, "plot_value")) == "vectorbtpro.portfolio.base.Portfolio.plot_value"
        assert vbt.get_fqn((pf, "get_filled_close")) == "vectorbtpro.portfolio.base.Portfolio.get_filled_close"
        assert vbt.get_fqn((pf, "get_sharpe_ratio")) == "vectorbtpro.portfolio.base.Portfolio.get_sharpe_ratio"
        assert vbt.get_fqn((pf, "sharpe_ratio")) == "vectorbtpro.portfolio.base.Portfolio.sharpe_ratio"

        assert vbt.get_fqn("vbt") == "vectorbtpro"
        assert vbt.get_fqn("vectorbtpro") == "vectorbtpro"
        assert vbt.get_fqn("vbt.utils") == "vectorbtpro.utils"
        assert vbt.get_fqn("utils") == "vectorbtpro.utils"
        assert vbt.get_fqn("vbt.utils.datetime_") == "vectorbtpro.utils.datetime_"
        assert vbt.get_fqn("datetime_") == "vectorbtpro.utils.datetime_"
        assert vbt.get_fqn("vbt.dt") == "vectorbtpro.utils.datetime_"
        assert vbt.get_fqn("vbt.nb") == "vectorbtpro.generic.nb"
        assert vbt.get_fqn("vbt.nb.rolling_mean_nb") == "vectorbtpro.generic.nb.rolling.rolling_mean_nb"
        assert vbt.get_fqn("rolling_mean_nb") == "vectorbtpro.generic.nb.rolling.rolling_mean_nb"
        assert vbt.get_fqn("vbt._settings.settings") == "vectorbtpro._settings.settings"
        assert vbt.get_fqn("vbt.settings") == "vectorbtpro._settings.settings"
        assert vbt.get_fqn("settings") == "vectorbtpro._settings.settings"
        assert vbt.get_fqn("vbt.Portfolio") == "vectorbtpro.portfolio.base.Portfolio"
        assert vbt.get_fqn("vbt.PF") == "vectorbtpro.portfolio.base.Portfolio"
        assert vbt.get_fqn("Portfolio") == "vectorbtpro.portfolio.base.Portfolio"
        assert vbt.get_fqn("PF") == "vectorbtpro.portfolio.base.Portfolio"
        assert vbt.get_fqn("Data.fetch_symbol") == "vectorbtpro.data.base.Data.fetch_symbol"
        assert vbt.get_fqn("YFData.fetch_symbol") == "vectorbtpro.data.custom.yf.YFData.fetch_symbol"
        assert vbt.get_fqn("Data.run") == "vectorbtpro.data.base.Data.run"
        assert vbt.get_fqn("YFData.run") == "vectorbtpro.data.base.Data.run"
        assert vbt.get_fqn("PF.cash_sharing") == "vectorbtpro.portfolio.base.Portfolio.cash_sharing"
        assert vbt.get_fqn("PF.close") == "vectorbtpro.portfolio.base.Portfolio.close"
        assert vbt.get_fqn("PF.plot_value") == "vectorbtpro.portfolio.base.Portfolio.plot_value"
        assert vbt.get_fqn("PF.get_filled_close") == "vectorbtpro.portfolio.base.Portfolio.get_filled_close"
        assert vbt.get_fqn("PF.get_sharpe_ratio") == "vectorbtpro.portfolio.base.Portfolio.get_sharpe_ratio"
        assert vbt.get_fqn("PF.sharpe_ratio") == "vectorbtpro.portfolio.base.Portfolio.sharpe_ratio"
        assert vbt.get_fqn("ADX") == "vectorbtpro.indicators.custom.adx.ADX"
        assert vbt.get_fqn("ADX.adx") == "vectorbtpro.indicators.custom.adx.ADX.adx"
        assert vbt.get_fqn("ADX.adx_above") == "vectorbtpro.indicators.custom.adx.ADX.adx_above"
